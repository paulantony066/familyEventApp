                  ...
                  ElevatedButton(
                      ...
                      onPressed: (){
                        ...
                        if(events.containsKey(_selectedDate)){
                          events[_selectedDate]?.add(Event(eventController.text));
                          //firestoreservice.addEvent(eventController.text);
                          eventController.clear();
                          Navigator.of(context).pop();
                          _selectedEvent.value = _getEventsForDay(
                              _selectedDate!);
                          ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                backgroundColor: Colors.grey[300],
                        ...
                        else if(!events.containsKey(_selectedDate)) {
                          //adds event to list map
                          events.addAll({
                            _selectedDate!: [Event(eventController.text)]
                          });
                          eventController.clear();
                          //firestoreservice.addEvent(eventController.text);
                          Navigator.of(context).pop();
